...
class ApiException private constructor(
    ...
    companion object {
        ...
        fun integrationNotFound() = ApiException(404, "CRM_INTEGRATION_NOT_FOUND", "CRM-интеграция не настроена")
        fun integrationNotConnected() = ApiException(409, "CRM_INTEGRATION_NOT_CONNECTED", "CRM-интеграция не подключена")
        fun integrationCredentialUnavailable() = ApiException(409, "CRM_CREDENTIAL_UNAVAILABLE", "Сохранённый ключ CRM недоступен. Укажите новый API-ключ")
        fun childManagedByCrm() = ApiException(409, "CHILD_MANAGED_BY_CRM", "Имя, фамилия, дата рождения и статус этого ребёнка управляются CRM")
        fun crmConnectionFailed(status: String) = ApiException(502, "CRM_CONNECTION_FAILED", "Не удалось связаться с CRM")
