...
export function SpecialistDetailsPage() {
  ...
  const lessons = useQuery({ queryKey: ["specialist-lessons", specialistId], queryFn: () => api.specialistLessons(specialistId), enabled: Boolean(specialistId) });
